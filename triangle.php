...
<body>
    ...
    <form method="post">
        Give a the value of base <input type="text" name="base" /> <br> <br>
...
if ($_POST) {
    ...
    $compute = ($base * $heigth * 0.5);


    echo "The Area value of rectangle with base = $base and heigth = $heigth is $compute.";
}
