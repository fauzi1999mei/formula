...
<body>
    ...
    <!-- square -->
    <h2> Area of Cylinder </h2><br>
    <!-- picture -->
    <figure><img src="" alt=""></figure>
    <form method="post">
        Give a the value of radius <input type="text" name="radius" /> <br> <br>
...
if ($_POST) {
    ...
    $compute = (2 * $pi * $radius * ($radius + $heigth));


    echo "The Area value of rectangle with radius = $radius and heigth = $heigth is $compute.";
}
